      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-title">
            <span>Escolha sua localidade para acessar nosso </span>
            <h2>SETOR DE EVENTOS</h2>
            <div class="separator"></div>
            <div class="login-social text-center">
              <div class="col-md-12">
                <ul><br><br>
                <a href="./eventos_CE.php" class="button red"> Apenas Ceará </a>
                  <a href="./eventos_Brasil.php" class="button red"> outros estados </a>
                </ul>
              </div>
            </div>
          </div>
