      ...
      <div class="row">
        ...
        <div class="col-md-12 justify-content-center">
          <div class="section-title">
            <span>Queremos estar sempre próximos para te</span>
            <h2>OUVIR </h2>
      ...
      <div class="row">
          ...
          <div class="gray-form row">
            <div class="col-md-12">
              ...
              <form class="form-horizontal" id="contactform" role="form" method="post" action="php/contact-form.php">
                ...
                <!------------------ START IFRAME ------------------>
                <iframe width="100%" height="515" src="https://adm.evogerencial.com.br/novaOuvidoria/1"
        ...
        <div class="col-lg-4 col-sm-12">
          ...
          <div class="feature-box-3">
            ...
            <div class="content">
              <h5>WhatsApp </h5>
              <a href="https://wa.me/553133321186?text=Olá,%20desejo%20conhecer%20melhor%20o%20Clube%20de%20Benefícios%20Abraço!">
          ...
          <div class="opening-hours gray-bg">
            <h6>Atendimento Consultor - Matriz</h6>
            <ul class="list-style-none">
              <li><strong>Segunda</strong> <span> 8:30 às 17:00 </span></li>
              <li><strong>Terça</strong> <span> 8:30  às 17:00 </span></li>
              <li><strong>Quarta </strong> <span> 8:30  às 17:00 </span></li>
              <li><strong>Quinta </strong> <span> 8:30  às 17:00 </span></li>
              <li><strong>Sexta </strong> <span> 8:30  às 17:00 </span></li>
              <li><strong>Sábado</strong> <span class="text-red"> Fechado</span></li>
              <li><strong>Domingo</strong> <span class="text-red"> Fechado</span></li>
            </ul>
          </div>
          <!------------------ END OPENING HOURS ------------------>
