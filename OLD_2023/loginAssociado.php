      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-title">
            <span>Escolha sua localidade para ter acesso à </span>
            <h2>Área do Associado</h2>
            <div class="separator"></div>
            <div class="login-social text-center">
              <div class="col-md-12">
                <ul><br><br>
                <a href="./segunda_via_cpf-1/loginAssociado_CE.php" class="button red"> Apenas Ceará </a>
                  <a href="./segunda_via_cpf/loginAssociado_Brasil.php" class="button red"> outros estados </a>
                </ul>
              </div>
            </div>
          </div>
